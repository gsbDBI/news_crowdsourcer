...
var URLQuestion = TextQuestion.extend({
    validate : function () {
    	var negatives = ['facebook.com', 'opensecrets.org', 'fec.gov', 'campaignmoney.com', 'insidegov.com', 'ioncongress.com', 'fecwatch.org']
    	if(this.response() == "") {
    		return false;
    	} else if(_.any(negatives, function(negative) { return this.response().includes(negative) }, this)) {
			return false;
    	} else{
